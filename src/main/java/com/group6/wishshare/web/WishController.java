...
public class WishController {
  ...
  public String wishlist(WebRequest webRequest, @PathVariable int id, Model model) {
    ...
    if (userService.isValidUser((Integer) webRequest.getAttribute("user", webRequest.SCOPE_SESSION))) {
      User user =
  ...
  public String sharedWishlist(WebRequest webRequest, @PathVariable int id, Model model) {
    ...
    if (!userService.isValidUser((Integer) webRequest.getAttribute("user", webRequest.SCOPE_SESSION))) { // Is owner not just valid user
...
//  private boolean isValidUser(WebRequest request) { //TODO SELT
